...
In order to build our models, we will focus on typical anecdotal factors linked to a movie's financial success, such as budget, date of release, its cast's popularity, and its director's name brand recognition. We will also take into account control variables such as runtime and genre.
