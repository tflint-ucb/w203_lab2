...
title(main = 'Logarithmic Movie Revenue over Budget')
...
title(main = 'Logarithmic Movie Revenue over Movie Runtime')
...
model <- lm(log(revenue) ~ log(budget) + comedy + drama + family + romance + thriller + animation + adventure + horror + music + crime + sci_fi + action + war + western + fantasy + foreign + mystery + history + documentary, data=final_table)
...
model <- lm(log(profitability_ratio) ~ log(budget) + comedy + drama + family + romance + thriller + animation + adventure + horror + music + crime + sci_fi + action + war + western + fantasy + foreign + mystery + history + documentary, data=final_table)
