...
We are running two models, one with the log of gross revenue as the dependent variable, and one with the profitability ratio 
...
title(main = 'Distribution of Lilm Budgets', xlab = 'Budget (USD)', ylab = 'Count')
...
ggplot(final_table, aes(x=log(profitability_ratio))) + geom_histogram(bins = 100)
